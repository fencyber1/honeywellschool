...
function Index() {
  return (
    <main>
      ...
      <Section dark eyebrow="Campus life" title="A campus that feels like home, built for growth."><div className="grid items-center gap-10 lg:grid-cols-2"><div className="skew-x-3 overflow-hidden rounded-xl border border-paper/20 bg-paper/10 p-2"><img src={campusImage} alt="Honeywell School children enjoying an outdoor activity course" width={1536} height={1920} loading="lazy" className="aspect-[4/3] w-full object-cover object-center" /></div><div><p className="max-w-xl leading-relaxed text-paper/70">Purpose-built labs, studios, courts, gardens, and welcoming classrooms keep learning moving beyond the desk.</p><div className="mt-7"><StatGrid dark items={[["40*","Campus acres"],["32*","Clubs"],["18*","Sports"],["6*","Creative studios"]]} /></div><Button asChild className="mt-6 rounded-none bg-action text-action-foreground"><Link to="/campus">Explore campus <ArrowRight /></Link></Button></div></div></Section>
