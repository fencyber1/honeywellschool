...
import heroAsset from "@/assets/honeywell-real-reading.png.asset.json";
import campusAsset from "@/assets/honeywell-real-playground.png.asset.json";
    ...
    <main>
      <section className="relative overflow-hidden bg-ink text-paper">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-5 py-14 lg:grid-cols-12 lg:py-20">
          ...
          <div className="lg:col-span-5"><div className="relative"><div className="absolute -inset-3 rotate-3 rounded-xl bg-trust/50" /><div className="relative -skew-x-3 overflow-hidden rounded-xl border border-paper/20 bg-paper/10 p-2"><img src={heroAsset.url} alt="Honeywell School pupils reading together in their classroom" width={547} height={365} fetchPriority="high" className="aspect-[4/5] w-full object-cover object-center" /></div><div className="absolute -bottom-5 -left-3 rounded-lg border border-paper/20 bg-ink/70 px-4 py-3 backdrop-blur-md"><p className="text-2xl font-black">1,240*</p><p className="text-[10px] uppercase tracking-[0.16em] text-paper/60">Students · 14 nations</p></div></div></div>
        </div>
      </section>
      <DemoNotice />
      ...
      <Section dark eyebrow="Campus life" title="A campus that feels like home, built for growth."><div className="grid items-center gap-10 lg:grid-cols-2"><div className="skew-x-3 overflow-hidden rounded-xl border border-paper/20 bg-paper/10 p-2"><img src={campusAsset.url} alt="Honeywell School children enjoying an outdoor activity course" width={398} height={498} loading="lazy" className="aspect-[4/3] w-full object-cover object-center" /></div><div><p className="max-w-xl leading-relaxed text-paper/70">Purpose-built labs, studios, courts, gardens, and welcoming classrooms keep learning moving beyond the desk.</p><div className="mt-7"><StatGrid dark items={[["40*","Campus acres"],["32*","Clubs"],["18*","Sports"],["6*","Creative studios"]]} /></div><Button asChild className="mt-6 rounded-none bg-action text-action-foreground"><Link to="/campus">Explore campus <ArrowRight /></Link></Button></div></div></Section>
